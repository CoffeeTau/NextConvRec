...
python main.py  --data_name Beauty \
                ...
                --train_name NextConvRec_Beauty
```
# How to test pretrained NextConvRec
...
- You can easily train the baseline models used in BSARec by changing the `model_type` argument.
  - `model_type`: Caser, GRU4Rec, SASRec, BERT4Rec, FMLPRec, DuoRec, FEARec, BSARec
